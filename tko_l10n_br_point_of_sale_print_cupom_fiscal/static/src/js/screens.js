                ...
                if (confirmed) {
                    ...
                    if (options.invoice) {
                        ...
                        for (i = 0; i < orderlines.length; i++) {
                            //check pos_fiscal_code in product form
                            if (orderlines_disc[i].product.pos_fiscal_code) {
                                var aliquotaICMS = orderlines_disc[i].product.pos_fiscal_code;
                            }
                            // if not found check in tax codes
                            else {
                                var aliquotaICMS = 'I';
